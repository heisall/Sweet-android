...
//    private ArrayList<ThirdAlarmDev> thirdDevList = null; // 第三方报警设备
    ...
    private int cloudEnabled = -1; // （云存储服务开关） 2:不支持 云存储 0：关闭云存储 1：开启云存储
...
//    }
    ...
    public Device(String ip, int port, String gid, int no, String user,
        ...
        for (int i = 0; i < channelCount; i++) {
            channel = new Channel(this, i, i + 1, false,
                    false, fullNo + "_" + (i + 1));
...
//    }
    ...
    public JSONObject toJson() {
        ...
        try {
            ...
            object.put("addTime", addTime);// 设备添加时间
            try {
